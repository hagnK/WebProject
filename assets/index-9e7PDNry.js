...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Eo(e,t,n){let r=new Float32Array(fo),i=new W(0,1,0);return new Ji({name:`SphericalGaussianBlur`,defines:{n:fo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ko(),fragmentShader:`
	...
	`}var Ao=class extends on{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ni(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}),(0,$.jsx)(Kl,{onMagicView:u}),(0,$.jsx)(`div`,{style:{position:`fixed`,inset:0,pointerEvents:`none`,zIndex:90,background:`repeating-linear-gradient(0deg,transparent,transparent 2px,rgba(0,0,20,0.03) 2px,rgba(0,0,20,0.03) 4px)`}}),(0,$.jsx)(`div`,{style:{position:`fixed`,top:`50%`,right:28,transform:e?`translateY(-50%) scale(1)`:`translateY(-50%) scale(0.93)`,width:262,opacity:+!!e,pointerEvents:e?`auto`:`none`,transition:`opacity 0.6s ease, transform 0.6s ease`,fontFamily:`'Courier New', Courier, monospace`,zIndex:100},children:(0,$.jsxs)(`div`,{style:{background:`rgba(5,7,26,0.93)`,border:`1px solid rgba(80,130,220,0.35)`,borderRadius:6,padding:`18px 20px 16px`,boxShadow:`0 0 40px rgba(30,70,180,0.3), inset 0 0 30px rgba(0,0,0,0.5)`,backdropFilter:`blur(6px)`},children:[(0,$.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,marginBottom:12,alignItems:`center`},children:[(0,$.jsx)(`span`,{style:{color:`rgba(80,140,255,0.4)`,fontSize:`0.57rem`,letterSpacing:3},children:`SYS://CIPHER`}),(0,$.jsx)(`span`,{style:{color:o?`#44ff88`:`rgba(255,100,100,0.55)`,fontSize:`0.57rem`,letterSpacing:2},children:o?`● SOLVED`:`● LOCKED`})]}),(0,$.jsx)(`div`,{style:{borderTop:`1px solid rgba(80,130,220,0.2)`,marginBottom:14}}),(0,$.jsx)(`div`,{style:{color:`#6aa8ff`,fontSize:`0.86rem`,letterSpacing:3,marginBottom:14,fontWeight:700},children:(0,$.jsx)(Xl,{text:`PENROSE CIPHER`,delay:200},String(e))}),(0,$.jsxs)(`div`,{style:{color:`rgba(180,200,240,0.58)`,fontSize:`0.71rem`,lineHeight:1.8,marginBottom:16},children:[`불가능한 도형 속에 다섯 수가`,(0,$.jsx)(`br`,{}),`새겨져 있다. 규칙을 찾아라.`]}),(0,$.jsx)(`div`,{style:{background:`rgba(255,190,60,0.06)`,border:`1px solid rgba(255,190,60,0.22)`,borderRadius:4,padding:`10px 14px`,marginBottom:20,textAlign:`center`},children:(0,$.jsx)(`div`,{style:{color:`#ffc04d`,fontSize:`1.05rem`,letterSpacing:6,fontWeight:700,animation:`pulse-num 2.8s ease-in-out infinite`},children:`13 · 1 · 16 · 12 · 5`})}),o?(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`div`,{style:{color:`#44ff88`,fontSize:`0.7rem`,letterSpacing:3,marginBottom:10,textAlign:`center`},children:`✓ 해독 완료 — 다음 목적지:`}),(0,$.jsx)(`a`,{href:Jl,className:`pz-link`,style:{display:`block`,color:`#44ccff`,fontSize:`0.67rem`,textDecoration:`none`,wordBreak:`break-all`,border:`1px solid rgba(68,204,255,0.32)`,padding:`8px 10px`,borderRadius:4,background:`rgba(68,204,255,0.04)`,transition:`all 0.25s`,lineHeight:1.6},children:Jl})]}):(0,$.jsxs)(`form`,{onSubmit:e=>{e.preventDefault(),n.toLowerCase().trim()===ql?s(!0):(a(`wrong`),setTimeout(()=>a(`idle`),1500))},children:[(0,$.jsxs)(`div`,{style:{display:`flex`,gap:7,marginBottom:5},children:[(0,$.jsx)(`input`,{className:`pz-input`,value:n,onChange:e=>r(e.target.value),placeholder:`답을 입력하라...`,autoComplete:`off`,spellCheck:!1,style:{flex:1,background:`rgba(255,255,255,0.04)`,border:`1px solid ${i===`wrong`?`rgba(255,60,80,0.7)`:`rgba(80,130,220,0.32)`}`,borderRadius:4,color:`#b8d0ff`,padding:`8px 10px`,fontFamily:`inherit`,fontSize:`0.82rem`,transition:`border-color 0.3s, box-shadow 0.3s`}}),(0,$.jsx)(`button`,{className:`pz-btn`,type:`submit`,style:{background:`rgba(50,100,200,0.25)`,border:`1px solid rgba(80,140,255,0.4)`,color:`#7ab4ff`,borderRadius:4,padding:`8px 14px`,cursor:`pointer`,fontFamily:`inherit`,fontSize:`0.9rem`,transition:`all 0.2s`},children:`▶`})]}),i===`wrong`&&(0,$.jsx)(`div`,{style:{color:`rgba(255,80,100,0.85)`,fontSize:`0.62rem`,letterSpacing:2},children:`ERR: 코드 불일치`})]}),(0,$.jsx)(`div`,{style:{marginTop:14,borderTop:`1px solid rgba(80,130,220,0.15)`,paddingTop:10,color:`rgba(80,130,220,0.2)`,fontSize:`0.56rem`,letterSpacing:3,textAlign:`center`},children:`LEVEL 01 / ?? \xA0■`})]})})]})}(0,u.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(l.StrictMode,{children:(0,$.jsx)(Zl,{})}));